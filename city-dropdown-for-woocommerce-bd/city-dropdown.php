<?php
/**
 * Plugin Name: Thana/Upazila Dropdown for Woocommerce [Bangladesh]
 * Plugin URI: https://github.com/immdraselkhan/Thana-Upazila-Dropdown-for-Woocommerce-Bangladesh
 * Description: This plugin helps you to transform the city field from your checkout page. It includes all cities from Bangladesh, based on each state.
 * Version: 1.0
 * Author: Md Rasel Khan
 * Author URI: https://raselnotes.com
 * Text Domain: woo-city-dropdown-bd
